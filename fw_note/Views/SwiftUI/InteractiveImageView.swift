                    ...
                    .gesture(
                        DragGesture()
                            .onChanged { gesture in
                                ...
                                let newWidth =
                                    newPointTRX - newPointTLX <= 0
                                    ? 0 : newPointTRX - newPointTLX
                                let newHeight =
                                    newPointBRY - newPointTLY <= 0
                    ...
                    .gesture(
                        DragGesture()
                            .onChanged { gesture in
                                ...
                                let newWidth =
                                    newPointBRX - newPointBLX <= 0
                                    ? 0 : newPointBRX - newPointBLX
                                let newHeight =
                                    newPointBRY - newPointTLY <= 0
                                    ? 0 : newPointBRY - newPointTLY
                                let newPositionX = newPointBLX + (newWidth / 2)
